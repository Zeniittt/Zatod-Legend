...
public class CharacterFX : MonoBehaviour
{
    ...
    public void CreateHemorrhage(Vector2 _position)
    {
        GameObject newHemorrhage = Instantiate(hemorrhagePrefab, _position + hemorrhageOffset, Quaternion.identity);
